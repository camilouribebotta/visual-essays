...
This visualization was created using the _[Storiiies](http://storiiies.cogapp.com/)_ site.  The Storiiies site was created for a presentation at the IIIF conference at the Vatican Library in June 2017, and updated for Museums and the Web 2018, showcasing experiments in digital storytelling using modern digital image technologies.  In this example we have annotated a plant specimen image for Agave from Gloabl Plants.
