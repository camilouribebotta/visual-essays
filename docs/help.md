...
- __active__: Defines whether the layer is initially displayed on the map.  The default value is `false`.  If this attribute is not set to `true` the user will need to activate the layer from the map control located on the map.  
...
1. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzMxNTI1NTEsLTU0NzI4Njg0NCwyMD
