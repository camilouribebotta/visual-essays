...
If we wanted to associate a directive with all text in section 1 the directive would be placed between Heading 1 and Sub
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQxMjI2NDIxNywtNjUwODI1MTE2LC0xMj
