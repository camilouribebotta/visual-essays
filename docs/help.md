...
- __data-aliases__:  When tagging entities in the essay text the text to match is defined by the label and aliases contained in the knowledge graph.  It is not uncommon for an entity to be reference in some other way in the text
- 
### data-map
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyODY2MDk5OCwxMjg1MTA0ODIzLC0xNT
