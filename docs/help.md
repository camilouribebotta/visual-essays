...
For visual essay sites with known domains (i.e., **plant-humanities.app** and **kent-maps.online**) the GITHUB-ACCOUNT and GITHUB-REPOSITORY is omitted in the URL.
...
1. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzI3OTE4NzM1LDEzOTQxMTgwNzQsODkxMj
